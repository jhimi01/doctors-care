...
const Process = () => {
  return (
    <div className="relative">
      ...
      <h2 className="text-center text-5xl text-[#1f2278] font-bold">
        How we work
      </h2>
      <div className="md:flex items-center justify-center gap-10 px-3 text-center md:w-3/4 w-full mx-auto md:mt-10 md:mb-20 my-10">
        ...
        >
          ...
          <h2 className="font-bold text-2xl text-[#f17732] group-hover:text-white">
            Make Appointment
          </h2>
          ...
          <button className="text-xl btn rounded-md bg-[#f17732] text-white hover:bg-[#e08c68]">
            Read More
          </button>
        </div>
        ...
        <div
          style={{ boxShadow: "15px 15px 30px 0px #f56918c5" }}
          className="bg-[#f17732] rounded-lg flex items-center px-5 py-8 space-y-7 flex-col"
        >
          ...
          <button className="text-xl btn rounded-md text-[#f17732] bg-white hover:bg-[#e08c6800] hover:text-[#fff]">
            Read More
          </button>
        </div>
        <div
      ...
      <div>
        <img
          src={prop5}
          alt="prop"
          className="hidden md:block animatespin absolute left-24 bottom-8"
        />
      </div>
      <div>
        <img
          src={prop8}
          alt="prop"
          className="animate-updown hidden md:block absolute top-36 right-32"
        />
      </div>
    </div>
  );
